...
class NetworkModelTest(unittest.TestCase):
    ...
    @patch('src.network.cookie_session.CookieSession._login')
    def test_login_value_exception(self, mocked_function):
        exception_string = "no username and password found"
        mocked_function.side_effect = ValueError(exception_string)
